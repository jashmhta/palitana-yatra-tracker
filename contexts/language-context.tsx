...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    onboarding_welcome_desc: "Experience the sacred journey to the holy Shatrunjaya Hill with 863 magnificent Jain temples. Track your pilgrimage across 16 checkpoints.",
    ...
    onboarding_track_desc: "Monitor pilgrim progress across all 16 checkpoints. See who has completed which stages of the sacred journey.",
  ...
  hi: {
    ...
    onboarding_welcome_desc: "पवित्र शत्रुंजय पहाड़ी की यात्रा का अनुभव करें जहां 863 भव्य जैन मंदिर हैं। 16 चेकपॉइंट्स पर अपनी तीर्थयात्रा ट्रैक करें।",
    ...
    onboarding_track_desc: "सभी 16 चेकपॉइंट्स पर यात्रियों की प्रगति देखें। जानें किसने पवित्र यात्रा के कौन से चरण पूरे किए हैं।",
  ...
  gu: {
    ...
    onboarding_welcome_desc: "પવિત્ર શત્રુંજય પહાડીની યાત્રાનો અનુભવ કરો જ્યાં 863 ભવ્ય જૈન મંદિરો છે. 16 ચેકપોઇન્ટ્સ પર તમારી તીર્થયાત્રા ટ્રેક કરો.",
    ...
    onboarding_track_desc: "બધા 16 ચેકપોઇન્ટ્સ પર યાત્રાળુઓની પ્રગતિ જુઓ. જાણો કોણે પવિત્ર યાત્રાના કયા તબક્કા પૂરા કર્યા છે.",
